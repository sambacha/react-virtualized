...
var ListExample = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(ListExample, [{
    ...
    value: function render() {
      ...
      }), /*#__PURE__*/React.createElement(ContentBoxParagraph, null, "The list below is windowed (or \"virtualized\") meaning that only the visible rows are rendered. Adjust its configurable properties below to see how it reacts."), /*#__PURE__*/React.createElement(ContentBoxParagraph, null, /*#__PURE__*/React.createElement("label", {
      ...
      }), "Show scrolling placeholder?")), /*#__PURE__*/React.createElement(InputRow, null, /*#__PURE__*/React.createElement(LabeledInput, {
        label: "Num rows",
        name: "rowCount",
